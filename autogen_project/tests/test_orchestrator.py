...
class TestTaskOrchestrator:
    ...
    def test_multi_agent_workflow_success(self, mock_factory):
        ...
        result = orchestrator.run_multi_agent_workflow(workflow)
    ...
    @patch('api.orchestrator.DataAnalystAgent')
    def test_multi_agent_workflow_failure(self, mock_agent_class):
