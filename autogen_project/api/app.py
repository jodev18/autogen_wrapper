...
async def run_agent(request: TaskRequest):
    ...
    """
    try:
        orchestrator_logger.info(f"API request to run agent '{request.agent_name}'")
...
async def run_workflow(request: WorkflowRequest):
    ...
    """
    try:
        orchestrator_logger.info(f"API request to run workflow with {len(request.workflow)} steps")
...
async def run_enhanced_workflow(request: EnhancedWorkflowRequest):
    ...
    """
    try:
        orchestrator_logger.info(f"API request to run enhanced workflow with {len(request.workflow)} steps")
